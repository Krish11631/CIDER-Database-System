...
CREATE TABLE `case_officer` (
  ...
  CONSTRAINT `case_officer_ibfk_1` FOREIGN KEY (`Case_ID`) REFERENCES `case_file` (`Case_ID`) ON DELETE CASCADE,
  CONSTRAINT `case_officer_ibfk_2` FOREIGN KEY (`Officer_ID`) REFERENCES `cider_hr`.`officer` (`Officer_ID`) ON DELETE CASCADE
